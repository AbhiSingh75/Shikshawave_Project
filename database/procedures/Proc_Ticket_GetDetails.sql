...
-- Get ticket details with activity log and attachments
-- =============================================
...
BEGIN
    ...
    IF @RoleID = 2 AND @UserSchoolID != @SchoolID -- School Admin
    BEGIN
        SET @ErrorMessage = 'Access denied: ticket belongs to different school';
        RETURN 403;
    END
    ELSE IF @RoleID = 4 AND @AssignedTo != @UserID -- Support Executive
    BEGIN
