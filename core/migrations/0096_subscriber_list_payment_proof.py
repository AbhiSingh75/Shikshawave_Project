# core/migrations/0096_subscriber_list_payment_proof.py
from django.db import migrations

class Migration(migrations.Migration):

    dependencies = [
        ('core', '0095_subscriber_payment_proof'),
    ]

    operations = [
        migrations.RunSQL("""
            -- Drop existing to re-define with new return column
            DO $$ 
            DECLARE 
                func_record RECORD;
            BEGIN
