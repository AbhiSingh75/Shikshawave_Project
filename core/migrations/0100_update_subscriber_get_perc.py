...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0099_referral_incentive_expansion'),
    ]

    operations = [
        migrations.RunSQL("""
            -- Forced refinement of fn_subscriber_get_list to include IncentivePercentage
            DO $$ 
            DECLARE 
                func_record RECORD;
            BEGIN
            ...
            CREATE OR REPLACE FUNCTION fn_subscriber_get_list(
                ...
                referralincentivepercent NUMERIC, -- NEW COLUMN
                isactive BOOLEAN,
                isrenewed BOOLEAN,
                renewalparentid INT,
                createdby INT,
