...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0089_subscription_report_details_support'),
    ]

    operations = [
        migrations.RunSQL("""
            -- Forced refinement of fn_subscriber_get_list to consistent 32-column structure
            DROP FUNCTION IF EXISTS fn_subscriber_get_list(INT, INT, VARCHAR, BOOLEAN, VARCHAR);
            DROP FUNCTION IF EXISTS fn_subscriber_get_list(INT, INT, VARCHAR, BOOLEAN, VARCHAR, INT, INT, VARCHAR, VARCHAR, INT);
            ...
            CREATE OR REPLACE FUNCTION fn_subscriber_get_list(
                ...
                isdeleted BOOLEAN,
                schoolid INT,
                maxstudents INT,       -- Column 28
                maxteachers INT,       -- Column 29
                storagelimitmb INT,    -- Column 30
                totalcount INT         -- Column 31
            ) AS $$
            BEGIN
                RETURN QUERY
