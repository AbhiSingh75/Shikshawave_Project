# Generated manually to create Salary Component Master CRUD procedure
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0043_create_unified_feetype_procedure'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            """
            -- Create unified procedure for Salary Component Master CRUD operations
            ...
            END;
            """,
            reverse_sql="DROP PROCEDURE IF EXISTS Proc_SalaryComponentMaster_Manage;"
        ),
    ]
