...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0073_add_rollnumber_to_fee_details_final'),
    ]
    ...
    operations = [
        migrations.RunSQL(
            ...
            BEGIN
                ...
                -- 1. Result Set: Student Information (Corrected RollNumber)
                OPEN ref1 FOR
                SELECT 
                    s."StudentID",
                    s."StudentCode",
                ...
                -- 2. Result Set: Fee Structure (Corrected table column naming)
                OPEN ref2 FOR
                SELECT 
                ...
                WHERE sfa."StudentId" = p_student_id AND sfa."Status" != 'Deleted';
                RETURN NEXT ref2;
            ...
            $$ LANGUAGE plpgsql;
            """,
            reverse_sql='-- Final correction migration'
        )
    ]
